...
As a parent, you must be provided with a complete explanation of all the safeguards on at least one occasion during the year. These include the rights that parents and children have when they go through the special education process.

"Parental rights" or, more formally known as Procedural Safeguards, are legal protections in place for both parents and children with disabilities. Understanding these safeguards is crucial so that you can always advocate for what is best for your child. The IDEA includes safeguards to protect your right(s) to:

- participate in all meetings
- examine all educational records
- obtain an independent educational evaluation (IEE) of your children
- opportunity to present and resolve complaints through procedures for due
