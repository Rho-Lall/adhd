---
title: "IEPs and 504s: Why an IEP May Be Better"
chapter: 310
publish: "2022-06-18"
update: "2022-06-18"
...
IDEA ensures your child receives an individualized education program (IEP) that is designed to meet his or her unique needs to provide your child with educational benefits, so your child will be prepared “for employment and independent living.” 
...
IDEA’s standard recognizes that such an education may not be sufficient for an ADHD elementary student due to complications from their ADHD. When this is the case IDEA outlines the development of an individualized education program (IEP) that must “provide your child with educational benefit.”
...
The shorthand between the two comes down to two words: accommodations vs specialized education. If your child simply needs accommodations in order to access the general education curriculum then a 504 will be implemented. If however the general education curriculum is insufficient and your child requires specialized education then an IEP will be appropriate. 
...
To qualify for special education services under IDEA your child must have a qualifying disability that is affecting their ability to learn. Even if they don’t qualify for services under IDEA they may still qualify for protections under Section 504.

To be eligible for protections under Section 504 your child must have a mental impairment that substantially limits at least one major life activity. Examples of major life activities include hearing, learning, reading, writing, performing math calculations, working, and performing manual tasks.
