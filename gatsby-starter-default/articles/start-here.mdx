...
### Start Here
We stary you here with a broad overview of what you need to know and what you need to get going. Here we cover step one, request to have your child tested for an IEP.
- Testing Your Child for an IEP: Why It's Important and How to Do It

### Organization Tips for the Busy Parent
After you request your child be tested the next most critical thing you need is to organize your documentation. In this section we cover step two, get organized. Half the battle is already won through organization and preparation. This isn't a prerequisite to the work at hand . . . this is the work at hand.

### Why an IEP May Be Better Than a 504 Plan for Your ADHD Elemetary Student
This section and the ones that follow will help you get up the learning curve on subject matter expertise. In this section we discuss IEPs, 504s, and the differences. I've created specific sections for each of them:
- IEPs for ADHD
- 504 Plans for ADHD

### How to Be An Effective Project Manager for Your Child's IEP Team
These sections are ordered according to immediacy, what you need to know as you go through the steps to secure accommodations for your ADHD elementary student. This next section focuses on project management topics around setting goals. Later when you create an IEP half the work is setting goals. Topics include:
...
In this section we circle back to building subject matter expertise specifically about ADHD. Topics include:
- ADHD in the Classroom
- High Achievers with ADHD

### What Every Parent of an ADHD Child Should Know About Their Legal Rights
In this section we dig deep into the law to understand your rights and your ADHD student's rights. Topics include:
